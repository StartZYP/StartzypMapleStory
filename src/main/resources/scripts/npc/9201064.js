...
function start() {
    cm.sendSimple("我是这家美发店的负责人。如果你有 #b#t5150031##k 或 #b#t5151026##k,请允许我帮你理一下发型。请选择你想要的.\r\n#L1#理发: #i5150031##t5150031##l\r\n#L2#染发: #i5151026##t5151026##l");
}
    ...
    if (mode < 1)  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (status == 1) {
            if (selection == 1) {
                ...
                cm.sendStyle("我完全可以改变你的发型，让它看起来很好看。你为什么不改一下呢？使用 #b#t5150031##k,剩下的我帮你处理。选择你喜欢的风格！", hairnew);
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendStyle("我完全可以改变你的发型颜色，让它看起来很好看。你为什么不改一下呢？ 使用#b#t5151026##k, 剩下的我来处理。选择你喜欢的颜色！", haircolor);
            }
        }
        else if (status == 2){
            cm.dispose();
