...
function action(mode, type, selection) {
	...
	*/
		if(status == 0) {
			cm.sendGetText("我这里可以通过道具名模糊查找掉落数据，想查什么道具的掉落？");
		} else if(status == 1) {
			var text = cm.getText();
			...
			var text = "以下是查询到#r#z" + items[selection] + "##k的掉落怪物有：\r\n";
			...
			var text = "查询到#r#o" + droppers[selection] + "##k的分布如下，点击地图名将交费#b"+10*level*level+"#k金币进行快速移动。\r\n";
