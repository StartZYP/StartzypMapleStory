...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("好吧,你好!欢迎来到玩具城整形医院!你想换一个新脸型吗?如果你有#b#t5152007##k, 你就可以改头换面啦~! \r\n#L2##b使用:#i5152007##t5152007##l#k");
        } else if (status == 1) {
            if (selection == 2) {
                facenew = Array();
                ...
                cm.sendStyle("让我们看看。。。我完全可以把你的脸变成新的。你不想试试吗？使用#b#t5152007##k,你可以选择你喜欢的面孔。花点时间选择吧！", facenew);
            }
        }
        else if (status == 2){
            cm.dispose();
            if (cm.haveItem(5152007)){
                ...
                cm.sendOk("嗯... 看来你没有#b#t5152007##k。很抱歉，没有优惠券，就没有整容手术了。。。");
            }
        }
    }
}
