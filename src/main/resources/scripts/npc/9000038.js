...
function action(mode, type, selection) {
        if (mode == -1) {
                ...
                if (status == 0) {
                        var sendStr = "这里是 #b挑战BOOS 组队任务#k 根据团队在boss游戏中走了多远来奖励玩家.注意每个球员 #b只有通过休息点的传送门才能获得奖励#k.挑战更强的老板需要团队投入更多的战斗,直到下一个休息点到达,或者直到最后一个BOSS被击败.对那些离开选择的休息地点的可能的奖励有:\r\n\r\n#b";
                        for(var i = 0; i < 6; i++) {
                        ...
                        var sendStr = "下列道具将于 #b" + levels[selection] + "#k:\r\n\r\n";
