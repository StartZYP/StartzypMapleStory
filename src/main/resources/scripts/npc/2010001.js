...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("你好,我是米努.如果你有#b#t5150005##k或#b#t5151005##k,我会为你更换发型.请选择一种发型.\r\n#L1#使用#b#i5150005##t5150005##l#k\r\n#L2#使用#b#i5151005##t5151005##l");
        } else if (status == 1) {
            if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                ...
                cm.sendStyle("使用#b#t5150005##k选择你喜欢的发型!", hairnew);
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendStyle("使用#b#t5151005##k选择你喜欢的发型颜色!", haircolor);
            }
        }
        else if (status == 2){
            cm.dispose();
            if (beauty == 1){
                if (cm.haveItem(5420004)){
                    ...
                    cm.sendOk("嗯...很抱歉你没有#b#t5151005##k无法进行更换");
                }
            }
            if (beauty == 2){
