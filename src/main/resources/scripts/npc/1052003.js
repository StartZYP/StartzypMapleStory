...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var options = new Array("制作矿石", "制作宝石", "铁甲猪蹄");//"升级拳套"
        ...
        if (selectedType == 0) { //mineral refine
            ...
            var selStr = "你知道吗?很多人不知道,在铁甲猪蹄金属的力量,我可以使它成为一些特别的东西,如果你需要我帮你的话!";
            equip = false;
            cm.sendYesNo(selStr);
        } else if (selectedType == 3) { //claw refine
            var selStr = "啊你想要升级拳套，告诉我要升级哪一个?\r\n#e#r(这边有小BUG例如你选错你要升级的拳套)\r\n(请勿停止对话OR取消因为会断线这点请特别注意!)\r\n(所以请先选好您要升级的拳套)#k#n#b";
            var claws = new Array("赤红战神拳套#k - 飞侠 等级. 60#b", "蓝宝战神拳套#k - 飞侠 等级. 60#b", "黑战神拳套#k - 飞侠 等级. 60#b");
        ...
        var prompt = "所以,你要我制作一些 #t" + item + "#?你需要制作多少个?";
        ...
        if (qty == 1)
            ...
            prompt += qty + " #t" + item + "#?";
        prompt += " 在这种情况下，我要为了做出好的品质。请确保您是否有足够的空间!#b";
