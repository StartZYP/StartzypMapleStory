...
function action(mode, type, selection) {
        if (mode == -1) {
                ...
                if(status == 0) {
                        ...
                        if(currentTier >= 0) sendStr = "使用您当前使用的橡皮擦, 您可以取回#r" + levels[currentTier] + "#k相应的奖励.使用橡皮擦:";
                        else sendStr = "你还没有使用橡皮擦.使用橡皮擦";
                        ...
                        cm.sendSimple(sendStr + "\r\n\r\n" + listStr + "#r#L" + getRewardIndex(hasCoin) + "#领奖!#l#k\r\n");
                        ...
                        try {
                                ...
                                cm.sendPrev("必须输入要插入正确的橡皮擦数.点击'#r退出#k'返回主界面..");
                                advance = false;
                        }
