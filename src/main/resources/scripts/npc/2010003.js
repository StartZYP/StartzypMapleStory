...
function action(mode, type, selection) {
    if (mode == 1)
        ...
        cm.dispose();
    if (status == 0 && mode == 1) {
        var selStr = "嗨，我是奈巴.有什么我可以帮助你的？#b"
        var options = new Array("做/升级战士手套", "做/升级弓箭手手套", "做/升级法师手套", "做/升级盗贼手套");
        ...
        if (selectedType == 0) { //warrior glove
            var selStr = "需要什么吗？？#b";
            var gloves = new Array("#t1082103##k - 战士 等级. 70#b", "#t1082104##k - 战士 等级. 70#b", "#t1082105##k - 战士 等级. 70#b",
                    "#t1082114##k - 战士 等级. 80#b", "#t1082115##k - 战士 等级. 80#b", "#t1082116##k - 战士 等级. 80#b", "#t1082117##k - 战士 等级. 80#b");
            for (var i = 0; i < gloves.length; i++) {
                selStr += "\r\n#L" + i + "# " + gloves[i] + "#l";
            }
            cm.sendSimple(selStr);
        } else if (selectedType == 1) { //弓箭手 glove
            var selStr = "需要什么吗？？#b";
        ...
        var prompt = "你想要做 #t" + item + "#? 在这种情况下, 我为了要做出最棒的品质，我建议你确保装备栏空间足够。#b";
