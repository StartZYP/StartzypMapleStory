...
function start() {
    cm.sendSimple("嗨，我是利纳斯.你有#b#t5154000##k, #b#t5150004##k, #b#t5150013##k或#b#t5151004##k吗？如果是的话，你觉得让我护理你的发型怎么样？你想怎么处理你的头发？\r\n#L0#使用: #i5154000##t5154000##l\r\n#L1#使用: #i5150004##t5150004##l\r\n#L2#使用: #i5150013##t5150013##l\r\n#L3#使用: #i5151004##t5151004##l");
}
    ...
    if (mode < 1)
        ...
        if (status == 1) {
            if (selection == 0) {
                ...
                cm.sendYesNo("如果你使用#b#t5154000##k，你的头发将随机改变，有机会获得完美风格。你是不是要来更改发型?");
            } else if (selection == 1) {
                beauty = 3;
                hairnew = Array();
                if (cm.getPlayer().getGender() == 0)
                ...
                cm.sendYesNo("如果你使用#b#t5150004##k，你的头发会随机改变。你打算改变你的发型吗？");
            } else if (selection == 2) {
                beauty = 1;
                hairnew = Array();
                if (cm.getPlayer().getGender() == 0)
                ...
                cm.sendYesNo("如果你使用#b#t5150013##k，你的头发将随机变化，有机会获得一个新的实验风格，你想改变你的发型吗?");
            } else if (selection == 3) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo("如果你使用#b#t5151004##k你的头发颜色会随机改变。你还想改变你头发颜色吗?");
            }
        }
        else if (status == 2){
            cm.dispose();
