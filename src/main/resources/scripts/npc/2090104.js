...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("嘿，我是诺玛，我正在协助帕塔换脸和配镜作为我的实习学习。如果你有 #b#t5152027##k 或 #b#t5152042##k, 我可以改变你的样子。现在，你想用什么?\r\n#L1#使用: #i5152027##t5152027##l\r\n#L2#使用: #i5152042##t5152042##l");
        } else if (status == 1) {
            if (selection == 1) {
                beauty = 1;
                facenew = Array();
                ...
                cm.sendYesNo("如果您使用普通优惠券，您将随机获得一副化妆镜片。你要用 #b#t5152042##k 真正改变你的眼睛颜色嘛?");
            }
        }
        else if (status == 2){
            cm.dispose();
