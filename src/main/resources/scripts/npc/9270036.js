...
function action(mode, type, selection) {
    if (mode < 1)
        ...
        if (selection == 1) {
            ...
            cm.sendStyle("如果你使用REG优惠券，你的头发将随机改变，有机会获得一种新的实验风格，我想出了. 你要用 #b#t5150032##k 真的要改变你的发型吗？", hairnew);
        } else if (selection == 2) {
            beauty = 2;
            haircolor = Array();
            ...
            cm.sendStyle("如果你使用REG优惠券，你的头发会随机改变。你还想用 #b#t5151027##k 把它改一下?", haircolor);
        } else if (status == 2) {
            if (beauty == 1){
