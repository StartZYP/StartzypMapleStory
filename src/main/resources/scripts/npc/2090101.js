...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("我是这家店的发型助理。如果你有#b#t5150024##k 或 #b#t5151019##k 无论如何，那让我给你换个发型怎么样？\r\n#L1#使用: #i5150024##t5150024##l\r\n#L2#使用: #i5151019##t5151019##l");
        } else if (status == 1) {
            if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                ...
                cm.sendYesNo("如果你使用普通优惠券，你的头发将随机变化，有机会获得一个新的实验风格. 你还想用 #b#t5150024##k 来转变你的发型?");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo("如果你使用普通优惠券，你的头发会随机改变。你还想用#b#t5151019##k来转变你的发型?");
            }
        }
        else if (status == 2){
            cm.dispose();
            if (beauty == 1){
                if (cm.haveItem(5150024)){
                    ...
                    cm.sendOk("嗯... 你好像没有我们指定的优惠券……恐怕没有它我不能给你理发。我很抱歉...");
                }
            }
            if (beauty == 2){
                if (cm.haveItem(5151019)){
                    ...
                    cm.sendOk("Hmmm...你好像没有我们指定的优惠券…恐怕没有它我不能染你的头发。我很抱歉...");
                }
            }
            if (beauty == 0){
