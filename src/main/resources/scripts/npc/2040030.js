...
function action(mode, type, selection) {
    ...
    if (mode == -1) {
        ...
        if(status == -1) {
            cm.sendNext("你... 是不是将宠物带在身边呢？使用生命水的魔法，我成功研发出赋予玩偶生命的魔法。而人们将我获得生命的孩子称为 #b宠物#k。如果持有宠物的话，任何事情都可以来问我。.");
        }
        else if (status == 0)
            ...
            if (selection == 0) {
                ...
                status = 11;
                cm.sendNext("死掉了！其实这些小家伙并不是真正活着的，所以它们会死，我也不知道对不对啊。这些小家伙是将我的魔法力量与生命水的力量灌注在木偶身体里做出来的。当然当它们活动的时候，是与其他动物没什么两样");
            } else if (selection == 3)
            ...
            if(sel != 1)
                cm.dispose();
            cm.sendNextPrev("对了！宠物不大喜欢吃人类的食物。我的徒弟#b科尔#k在射手村的市集里卖#b宠物食品#k，如果需要食物就到射手村去。最好先买好食物，以防宠物失去力气哦。");
        } else if (status == 5)
