...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("嗨，我是这里的助理。别担心，我已经足够好了。如果你有 #b#t5150006##k, #b#t5150012##k 或 #b#t5151006##k无论如何，那就让我来处理剩下的，好吗?\r\n#L0#使用: #i5150006##t5150006##l\r\n#L1#使用: #i5150012##t5150012##l\r\n#L2#使用: #i5151006##t5151006##l");
        } else if (status == 1) {
            if (selection == 0) {
                beauty = 3;
                hairnew = Array();
                ...
                cm.sendYesNo("如果你使用#b#t5150012##k，你的头发将随机改变，有机会获得一个新的风格，你要改变你的发型吗?");
            } else if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                if (cm.getPlayer().getGender() == 0) {
                ...
                cm.sendYesNo("如果你使用#b#t5150012##k，你的头发将随机变化，有机会获得一个新的实验风格，你想改变你的发型吗?");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo("如果你使用普通优惠券，你的头发会随机改变。是否仍要使用 #b#t5151006##k 并对其进行更改？");
            }
        }
        else if (status == 2){
            cm.dispose();
