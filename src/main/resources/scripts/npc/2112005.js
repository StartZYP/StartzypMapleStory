                ...
                if(!eim.isEventCleared()) {
                        if(status == 0) {
                                if(eim.getIntProperty("npcShocked") == 0 && cm.haveItem(4001130, 1)) {
                                        ...
                                        if (cm.isEventLeader()) {
                                                ...
                                                cm.sendNext("太好了！你手头有阿尔卡多和泽努米斯特的档案。现在我们可以继续了.");
                        ...
                        if(status == 0) {
                                if(eim.getIntProperty("escortFail") == 0) {
                                        cm.sendNext("最后，罗密欧安全了！多亏你的努力，我们才能把他从尤利特的手中解救出来，尤利特现在将因反叛马加蒂而受到审判。从现在起，他将开始康复，我们将继续关注他的努力，确保他不会再给未来带来麻烦.");
                                }
                                else {
                                        cm.sendNext("罗密欧现在很安全了，虽然战斗给他带来了损失。。。多亏你的努力，我们才能把他从尤利特的手中解救出来，尤利特现在将因反叛马加蒂而受到审判。谢谢你.");
                                        status = 2;
                                }
                        } else if(status == 1) {
