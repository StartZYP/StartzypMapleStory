    ...
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                cm.sendYesNo("如果你使用REG优惠券，你的头发将随机改变，有机会获得一个新的实验风格，我想出了。你要用 #b#t5150011##k 来改变你的发型吗?");
            } else if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                if (cm.getPlayer().getGender() == 0) {
                ...
                cm.sendYesNo("如果你使用经验优惠券，你的头发将随机改变，有机会获得一个新的实验风格，我想出了.你要用 #b#t5150011##k 真的要改变你的发型吗?");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
