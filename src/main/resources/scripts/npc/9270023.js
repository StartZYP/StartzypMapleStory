...
function start() {
    cm.sendSimple("如果你使用这个普通的优惠券，你的脸可能会变成一个随机的新样子…你还想用 #b#t5152037##k, 我无论如何都会为你做的。但别忘了，这是随机的！\r\n\#L2#使用：#i5152037# #t5152037#l");
}
    ...
    if (mode < 1)  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (status == 1) {
            if (!cm.haveItem(5152037)) {
                cm.sendOk("嗯 ... 看来你没有这个地方的优惠券。很抱歉这么说，但是没有优惠券，就没有整容手术了。。。");
                cm.dispose();
                return;
            }
            ...
            cm.sendYesNo("如果你使用普通优惠券，你的脸可能会变成一个随机的新样子…你还想用 #b#t5152037##k?");
        } else if (status == 2){
