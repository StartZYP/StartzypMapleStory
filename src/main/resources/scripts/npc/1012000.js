...
function start() {
    cm.sendNext("你好，我是#b金银岛中巴#k,如果你想安全快速地从一个城镇到另一个城镇，那就搭我们的出租车吧。我们很乐意带您去您的目的地，价格实惠。");
}
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 1) {
            ...
            cm.sendYesNo("你没别的事要做了吧?你真的想去#b#m" + maps[selection] + "##k?你会花费#b"+ (cm.getJobId() == 0 ? cost[selection] / 10 : cost[selection]) + " 金币#k.");
