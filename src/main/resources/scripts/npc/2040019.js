...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("好吧，我很无聊，所以我会帮医生的。你有#b#t5152006##k吗？我会改变你的样子。但是他是随机改变的。 \r\n#L2##b使用#i5152006##t5152006##l#k");
        } else if (status == 1) {
            if (selection == 2) {
                facenew = Array();
                ...
                cm.sendYesNo("如果你使用#b#t5152006##k，你的脸可能会变成一个随机的新样子…你还想用#b#t5152006##k吗?");
            }
        }
        else if (status == 2){
            cm.dispose();
            if (cm.haveItem(5152006) == true){
                ...
                cm.sendOk("嗯... 看来你没有#b#t5152006##k。很抱歉，但是没有优惠券，就没有整容手术了。。。");
            }
        }
    }
}
