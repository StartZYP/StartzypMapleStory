            ...
            cm.dispose();
                ...
                if(eim.getProperty(stage.toString() + "stageclear") != null) {
                        ...
                        if (eim.isEventLeader(cm.getPlayer())) {
                                ...
                                if(state == -1) {           // preamble
                                        cm.sendOk("你好,欢迎来到#b" + stage + "#k.在这个阶段,有几个生物躲在这座塔内部的阴影里。他们中的一些人无法通过物理手段击败，因此需要魔法攻击来完成任务，而其他人则相反。击败他们然后带回6张#t4001022#'s给我.");
                                        eim.setProperty("statusStg" + stage, 0);
                                }
                                else {                      // check stage completion
                                        if (cm.haveItem(4001022, 6)) {
                                                cm.sendOk("做得好!你带来了6站#b#t4001022#'s.#k");
                                                cm.gainItem(4001022, -6);

                                                eim.setProperty("statusStg" + stage, 1);
                                                clearStage(stage, eim, curMap);
                                        } else {
                                                cm.sendNext("你确定有收集了#r6张次元的通行证#k？");
                                        }
                                }
                        } else {
