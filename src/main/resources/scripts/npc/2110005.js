...
var toMagatia = "你想乘坐#b骆驼#k去#b玛加提亚#k, 炼金术之城?车费是 #b1500 金币#k.";
var toAriant = "你想乘坐#b骆驼#k去#b阿里安特#k, 尼哈沙漠? 车费是 #b1500 金币#k.";
...
function action(mode, type, selection) {
    if (mode == 1) {
        if (cm.getMeso() < 1500) {
            cm.sendNext("我很抱歉，如果你没有足够的钱，恐怕我不能让你骑这个。当你有足够的钱用这个的时候在来吧。");
            cm.dispose();
       } else {
        ...
        cm.sendNext("嗯...太忙了，现在不能做吗？如果你想做，尽管回来找我。");
        cm.dispose();
}