...
function action(mode, type, selection) {
	if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
                if (type == 7) {
			cm.sendNext("我明白了…慢慢来，看看你是否真的想要。下定决心的时候告诉我.");
		}
		...
		if (mode == 1)
			...
			status--;
                ...
                if (status == 0) {
                        cm.sendSimple("嗨,我是这里的面部手术助理医生.用一个 #b#t5152029##k 或 #b#t5152048##k,相信我,我能把它改得很好.啊,别忘了,手术后接下来会发生什么是随机的!那么,你要干什么?\r\n#L1#使用: #i5152029##t5152029##l\r\n#L2#使用: #i5152048##t5152048##l");
                } else if (status == 1) {
                        if (selection == 1) {
                                beauty = 0;
                                ...
                                cm.sendYesNo("如果你使用普通优惠券，你的脸可能会变成一个随机的新样子…你还想用#b#t5152029##k?");
                        } else if (selection == 2) {
                                beauty = 1;
                                ...
                                cm.sendYesNo("如果您使用普通优惠券，您将随机获得一副化妆镜片。你要用#b#t5152048##k 来真正改变你的眼睛?");
                        }
                } else if (status == 2){	
			cm.dispose();
                        ...
                        if (beauty == 0) {
                                if (cm.haveItem(5152029) == true){
                                        ...
                                        cm.sendNext("嗯...看来你没有这个地方的优惠券…很抱歉,没有优惠券,就没有整容手术.");
                                }
                        } else if (beauty == 1) {
