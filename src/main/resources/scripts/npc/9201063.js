...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendSimple("我是助理艾瑞。如果你有 #b#t5150030##k 或 #b#t5151025##k 无论如何，让我给你换个发型怎么样？\r\n#L1#理发: #i5150030##t5150030##l\r\n#L2#染发: #i5151025##t5151025##l");
        } else if (status == 1) {
            if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                ...
                cm.sendYesNo("如果你使用随机优惠券，你的头发将随机改变，有机会获得一个新的实验风格，我想出了. 你真的要用 #b#t5150030##k 改变你的发型吗?");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo("如果你使用普通优惠券，你的头发会随机改变。你还想用 #b#t5151025##k 改变你的发型吗??");
            }
        }
        else if (status == 2){
            cm.dispose();
