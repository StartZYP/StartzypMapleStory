...
public class GenericLittleEndianWriter implements LittleEndianWriter {
    ...
    private static Charset ASCII = Charset.forName("GBK");//lynfan中文，汉化
    ...
    public void writeMapleAsciiString(String s) {
        //writeShort((short) s.length());//lynfan 原始代码
        if (s == null)
	s = "";
        writeShort((short) s.getBytes(ASCII).length);//lynfan 中文化，修复提示信息不支持中文的问题
        writeAsciiString(s);
    }
    
    /*lynfan added修复npc脚本中文对话显示不全问题
