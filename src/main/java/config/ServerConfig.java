...
public class ServerConfig {
    ...
    //Server Flags
    public boolean 启用怪物偷袭;//lynfan 启用怪物偷袭
    public boolean 野外通缉;//lynfan 启用野外通缉
    ...
    public int SCROLL_STAT_RATE;//lynfan added 卷轴属性倍率
    ...
    public boolean USE_PERFECT_PITCH;//lynfan 绝对音感
