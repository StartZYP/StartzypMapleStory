...
public class GameConstants {
    ...
    */
    // Ronan's rates upgrade system，lynfan comment:倍率成长系统
    private static final int[] DROP_RATE_GAIN = {1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 4, 5, 5};//lynfan 角色每升20级掉落倍率提升的矩阵。
    private static final int[] MESO_RATE_GAIN = {1, 1, 2, 2, 3, 3, 4, 4, 5, 6, 7, 8, 9, 10};//lynfan 角色每升20级金币倍率提升的矩阵。
    private static final int[]  EXP_RATE_GAIN = {1, 1, 2, 2, 3, 3, 4, 4, 5, 6, 7, 8, 9, 10};    //fibonacci :3//lynfan 角色每升20级经验倍率提升的矩阵。
