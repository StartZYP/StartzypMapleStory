...
import client.command.commands.gm0.抗压Command;
...
public class CommandsExecutor {
    ...
    private void registerLv6Commands(){
        levelCommandsCursor = new Pair<>((List<String>) new ArrayList<String>(), (List<String>) new ArrayList<String>());
        	addCommand("召唤玩家", 6, 召唤玩家Command.class);//lynfan added
		addCommand("20191231", 6, SuperBuffCommand.class);//lynfan added
		addCommand("进阶", 6, 开始进阶Boss.class);//lynfan added
		addCommand("吸怪", 6, 吸怪Command.class);//lynfan added
		addCommand("XG", 6, 吸怪Command.class);//lynfan added
	//	addCommand("反盾", 6, 抗压Command.class);//lynfan added
		addCommand("FD", 6, 抗压Command.class);//lynfan added
